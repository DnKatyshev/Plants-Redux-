export const Preloader = () => {
  ...
  return(
    <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" className="preloader"
      style={{shapRendering: 'auto', display: 'block', background: 'transparent'}}>
      <g>
        <g transform="rotate(0 50 50)">
          <rect fill="#50cd4e" height="12" width="6" ry="6" rx="3" y="24" x="47">
